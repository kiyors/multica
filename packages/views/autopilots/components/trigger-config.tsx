...
export function TriggerConfigSection({
  ...
  return (
    <div className="space-y-3">
      ...
      {config.frequency === "custom" ? (
        ...
        <div>
          ...
          <input
            ...
            placeholder="0 9 * * 1-5"
            className="mt-1 w-full rounded-md border bg-background px-3 py-2 text-body font-mono outline-none focus:ring-1 focus:ring-ring"
          />
              ...
              <>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <Select
                    ...
                    items={timezones.map(tz => ({ label: getTimezoneLabel(tz), value: tz }))}
                  >
      ...
      <p className="text-micro text-muted-foreground">{describeTrigger(config)}</p>
    </div>
  );
}
