      ...
      <div className="flex min-h-0 flex-col">
        ...
        >
          <div className="mx-auto w-full max-w-[620px] px-6 py-10 sm:px-10 md:px-14 lg:px-0 lg:py-14">
            <div className="mb-2 text-micro font-medium uppercase tracking-[0.08em] text-muted-foreground">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-end gap-x-4 gap-y-2">
              <span className="mr-auto hidden text-micro text-muted-foreground sm:block">
  ...
  return (
    ...
    >
      <div className="flex w-full items-start justify-between gap-2">
        <span
          aria-hidden
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-muted/70 font-serif text-title text-muted-foreground"
        >
          {template.emoji}
        </span>
        {recommended && (
          <span className="shrink-0 rounded-full bg-brand/10 px-2 py-0.5 text-micro font-medium uppercase tracking-wider text-brand">
  ...
  return (
    <div className="flex max-w-[380px] flex-col gap-8">
      <section className="flex flex-col gap-4">
        ...
        <h2 className="font-serif text-title-lg font-medium leading-[1.25] tracking-tight text-foreground">
      ...
      <p className="text-label leading-[1.55] text-muted-foreground">
...
function WayItem({
  ...
  return (
    <div className="grid grid-cols-[22px_1fr] gap-3">
      ...
      <div className="flex flex-col gap-1">
        <div className="text-body font-medium leading-tight text-foreground">
          {title}
        </div>
        <p className="text-label leading-[1.5] text-muted-foreground">
          {body}
        </p>
      </div>
    </div>
