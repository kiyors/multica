    ...
    <div className="animate-onboarding-enter flex h-full min-h-0 flex-col bg-background">
      ...
      >
        <div className="mx-auto w-full max-w-[920px] px-6 py-10 sm:px-10 md:px-14 lg:py-14">
          ...
          <div className="mb-1 font-mono text-micro text-muted-foreground">
            {String(number).padStart(2, "0")}
          </div>
          <h1 className="text-balance font-serif text-display-sm font-medium leading-[1.15] tracking-tight text-foreground">
            {question}
          </h1>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-end gap-x-4 gap-y-2">
            <span
              aria-live="polite"
              className="mr-auto text-micro text-muted-foreground"
            >
              {footerHint}
            </span>
