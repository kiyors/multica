...
const marketingGuideDescription = `Welcome to Multica! If you're running marketing campaigns, reviewing video assets, or approving design mockups, this guide will show you how to use Multica's task tracking and media review features to get your work done faster.
