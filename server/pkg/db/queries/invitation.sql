...
INSERT INTO workspace_invitation (workspace_id, inviter_id, invitee_email, invitee_user_id, role, initial_projects)
VALUES ($1, $2, $3, $4, $5, sqlc.narg('initial_projects'))
RETURNING *;
...
-- name: HasAnyPendingInvitationByEmail :one
SELECT EXISTS (
